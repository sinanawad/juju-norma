...
- A4 [F13] RESOLVED (M1, LXD cloud docs): LXD honors arch,cores,mem,root-disk,root-disk-source,virt-type,zones. ROADMAP(real-IAAS): cpu-power,instance-type,instance-role,tags,allocate-public-ip,image-id,spaces. verify exact live behavior in P6.
